...
function onPlaceChanged() {
    ...
    if(!place.geometry){
        ...
        document.getElementById('text-field').placeholder = 'Enter the location';    
        
    }else{
        cordinates = `${place.name} (${place.geometry.location.lat()}`;
        newCord = `${cordinates} , ${place.geometry.location.lng()})`;
        document.getElementById('text-field').value = newCord;
